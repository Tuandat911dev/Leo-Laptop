...
<div class="row justify-content-center">
    <div class="col-xl-10 col-lg-11">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form:form method="POST" action="/admin/products/create" modelAttribute="newProduct"
                        ...
                        <div class="col-md-5 text-center border-right">
                            <div class="product-image-upload">
                                <div class="product-image-edit">
                                    <input type='file' id="imageUpload" name="productFile"
                                           accept=".png, .jpg, .jpeg"/>
                            ...
                            <div class="alert alert-info text-left small mt-4">
                                <i class="fas fa-info-circle"></i> <b>Lưu ý:</b> Hãy chọn hình ảnh rõ ràng, nền trắng để
                                sản phẩm trông chuyên nghiệp hơn trên website.
                            </div>
                        </div>
