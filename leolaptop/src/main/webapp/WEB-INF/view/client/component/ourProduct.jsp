        ...
        <div class="tab-class">
            ...
            <div class="tab-content">
                ...
                <div id="tab-2" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <!-- Tương tự Tab 1, sửa icon ở tất cả sản phẩm -->
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item-inner border rounded">
                                    <div class="product-item-inner-item">
                        ...
                        <!-- Thêm các sản phẩm khác cho Tab 2 ở đây với cấu trúc icon đã sửa như trên -->
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item-inner border rounded">
                                    <div class="product-item-inner-item">
                                        <img src="img/product-14.png" class="img-fluid w-100 rounded-top" alt="">
                                        <div class="product-details"><a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                        </div>
                                    </div>
                                    <div class="text-center rounded-bottom p-4">
